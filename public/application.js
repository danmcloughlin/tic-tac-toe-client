...
/***/ function(module, exports, __webpack_require__) {
	...
	var populateSquare = function populateSquare() {
	  ...
	  if (gameStore.game.clickCount % 2 === 1) {
	    ...
	    api.updateBoard(data).then(ui.newMoveSuccess).catch(ui.newMoveFailure);
	  } else {
	    this.innerHTML = 'o';
	    var _value = 'o';
	    var _data = {
	    ...
	    api.updateBoard(_data).then(ui.newMoveSuccess).catch(gameStore.game.cells);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newMoveFailure = function newMoveFailure(error) {
	  console.error(error);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUpConfirm = function onSignUpConfirm(event) {
	...
	var onSignInConfirm = function onSignInConfirm(event) {
